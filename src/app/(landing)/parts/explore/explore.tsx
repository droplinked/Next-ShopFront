...
import { ExploreProducts, ExploreSidebar, ExploreTools } from "./parts";
    ...
    return (
        <ExploreContext.Provider value={{ states: States, methods: { updateStates } }}>
            <div className="flex items-start justify-between md:flex-row w-full gap-6">
                <div className="w-[20%] sticky top-24"><ExploreSidebar /></div>
                <div className={cn(app_vertical, "gap-9 w-full min-w-[80%]")}><ExploreTools /><ExploreProducts /></div>
            </div>
