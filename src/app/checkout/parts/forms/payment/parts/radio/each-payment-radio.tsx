                            ...
                            method.options.map((hook_option, key) => {
                                ...
                                <AppShow
                                    ...
                                    show={{
                                        ...
                                        then: (
                                            <AppRadioInput key={key} checked={selected_method?.name === shop_payment_methods?.type && selected_method.token === hook_option?.[selected_method.name]?.token } onChange={() => updateStates("selected_method", {name: shop_payment_methods?.type, token: hook_option?.[shop_payment_methods?.type]?.token, enum_number: hook_option?.[shop_payment_methods?.type]?.enum_number})} {...props}>
