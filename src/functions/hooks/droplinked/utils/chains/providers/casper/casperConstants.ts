...
export async function get_session(){
    let result = String((await axios.get(`https://apiv3dev.droplinked.com/storage/CasperPaymentSession`)).data.value);
    return result;
}
...
export const apiUrl = "https://apiv3dev.droplinked.com/http-req?method=post&url=http://188.40.47.161";
